...
// Recent bookings với thông tin tỉnh/thành phố
$stmt = $pdo->query("SELECT b.*, c.user_id, u.full_name, 
                     p1.name as departure_province, p2.name as destination_province,
...
$stmt = $pdo->query("SELECT 'booking' as type, b.booking_date as activity_date, 
                     ...
                     CONCAT('Chuyến đi mới: ', p1.name, ' → ', p2.name) as description,
