...
<body class="page-auth">
  <div class="card register-card">
    ...
    <form id="registerForm" novalidate>
      <label>Tên đăng nhập
        <input name="username" id="username" type="text" placeholder="Nhập tên đăng nhập (VD: user123)">
      </label>
      ...
      <label>Mật khẩu
        <input name="password" id="password" type="password" placeholder="Mật khẩu (Tối thiểu 6 ký tự)">
      </label>
