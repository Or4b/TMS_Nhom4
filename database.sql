...
-- Updated with 'paused' and 'full' status
-- Date: 2025-11-25
...
-- ĐÃ CẬP NHẬT: Thêm trạng thái 'paused' và 'full'
CREATE TABLE `trips` (
  `id` int(11) NOT NULL,
...
(1, 27, 25, '2025-02-01 07:00:00', 350000.00, 15, 20, 'scheduled', 'one-way', NULL, NOW()), 
(2, 27, 24, '2025-02-01 21:00:00', 280000.00, 8, 12, 'scheduled', 'round-trip', '2025-02-03 21:00:00', NOW()),
(3, 27, 28, '2025-02-02 08:30:00', 120000.00, 25, 30, 'scheduled', 'one-way', NULL, NOW()),
(4, 27, 30, '2025-02-02 06:00:00', 180000.00, 18, 25, 'scheduled', 'round-trip', '2025-02-04 06:00:00', NOW()),
(5, 27, 29, '2025-02-03 09:00:00', 200000.00, 10, 16, 'scheduled', 'one-way', NULL, NOW());
